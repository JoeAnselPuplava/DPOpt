...
int main(int argc, char **argv)
{
    ...
    // Optional: push filters before joins (demo value = 3)
    ...
    FilterOperatorSyscat f4(2, Integer(32, 5, ALICE), "eq", &r4_stats.at(2));
    planNode select4(&f4, &r4);
    SecureRelation r4_filtered = select4.get_output();

    // Step 1: r1_filtered JOIN r2_filtered on r1.c1 = r2.c1
    EquiJoinOperator join1_B(1, 1);
    SecureRelation r1_r2_B = join1_B.execute(r1_filtered, r2_filtered);

    // Step 2: r1_r2_B JOIN r3_filtered on r1.c2 = r3.c2
    EquiJoinOperator join2_B(2, 2);
    SecureRelation r1_r2_r3_B = join2_B.execute(r1_r2_B, r3_filtered);

    // Step 3: r1_r2_r3_B JOIN r4_filtered on r2.c2 = r4.c2
    EquiJoinOperator join3_B(5, 2);
    SecureRelation final_result_B = join3_B.execute(r1_r2_r3_B, r4_filtered);
